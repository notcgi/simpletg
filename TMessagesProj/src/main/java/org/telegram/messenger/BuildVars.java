...
public class BuildVars {
    ...
    // Filled from local.properties (APP_ID / APP_HASH) via BuildConfig — get yours at https://my.telegram.org/apps
    public static int APP_ID = BuildConfig.APP_ID;
    public static String APP_HASH = BuildConfig.APP_HASH;

    // SafetyNet key for Google Identity SDK, set it to empty to disable
    public static String SAFETYNET_KEY = "";
    public static String PLAYSTORE_APP_URL = "https://github.com/notcgi/simpletg";
    public static String HUAWEI_STORE_URL = "https://github.com/notcgi/simpletg";
